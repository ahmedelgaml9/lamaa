        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{route('compansations.create')}}" type="button" class="btn btn-primary">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="db_table">
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">{{__('admin.order_id')}}</th>
                    <th class="min-w-125px">{{__('admin.staff_notes')}}</th>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="{{route('compansations.edit', $c->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$c->id}}">{{__('admin.delete')}}</a>                    
                            </div>
                        </div>
                    </td>
                </tr>
                       ...
                       <div id="kt_modal_1{{$c->id}}"  tabindex="-1" class="modal fade">
                              ...
                              <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    ...
                                    <div class="text-center pt-15">
                                        ...
                                        {!! Form::open(['url' => route('compansations.destroy',  $c->id), 'method' => 'delete']) !!}
