          ...
          <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" placeholder="{{__('admin.name')}}" id="name" name="name" class="form-control" required>
                    </div>
                </div>

                  <div class="card-header border-0 pt-5"> 
                        <h5 class="card-title align-items-start flex-column">{{__('admin.permissions') }}</h5>
                    </div>
                     <br>
