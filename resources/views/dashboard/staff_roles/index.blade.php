...
<div class="d-flex flex-wrap flex-stack pb-7">
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bolder me-5 my-1">{{__('admin.roles')}}</h3>
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="db_table">
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">{{__('admin.role')}}</th>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="{{route('roles.edit', $role->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                            </div>
                            @if($role->id != 12)<div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$role->id}}">{{__('admin.delete')}}</a>                      
                              </div>@endif
                          </div>
                      </td>
                   </tr>
                ...
                <div id="kt_modal_1{{$role->id}}"  tabindex="-1" class="modal fade">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                                    ...
                                    <div class="text-center pt-15">
                                        ...
                                        {!! Form::open(['url' => route('roles.destroy', $role->id), 'method' => 'delete']) !!}
