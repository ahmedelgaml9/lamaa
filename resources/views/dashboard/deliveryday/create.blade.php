            ...
            <div class="card">
                <div class="card-header border-0 pt-5">
                  ...
                  <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                       {!! Form::open(['url' => route('deliverydays.store', $day->id), 'method' => 'post', 'files'=>true]) !!}
                     <div class="row">
                         <div class="col-xl-6">
                            ...
                            <div class="table-responsive">
                                 <table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-bold fs-6 gy-5">
                                     <thead>
                                        ...
                                        <tbody id="newRow">
                                            <tr id="inputFormRow">
                                                  <td><input  type="text" class="form-control form-control-solid kt_datepicker_2" name="start_time[]" />
                                                  <td><input  type="text" class="form-control form-control-solid kt_datepicker_2"  name="end_time[]" />
                                               </td>
                                                 <td><input  type="number" class="form-control"  name="max_orders_to_accept[]"  required/>
                                                 <td>
