     ...
     <div class="d-flex align-items-center py-1">
           <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#subscriptions">
            ...
            {{__('admin.filter')}}</button>
               ...
               <a href="{{route('export_cashback', request()->query())}}" class="btn btn-sm btn-flex btn-dark btn-active-primary fw-bolder"><i class="fa fa-file-download"></i>تصدير</a>
               <label  class="col-form-label  fw-bold fs-6"></label>
                 @if(request()->query() == null)<a href="{{url('admin/cashbackreports/pdf')}}"  target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-print"></i></a>@endif
               </div>
          ...
          <div class="d-flex flex-wrap flex-stack pb-7">
           <div class="d-flex flex-wrap align-items-center my-1">
              <div class="d-flex align-items-center position-relative my-1">
                <form action="{{route('cashback_reports')}}" id="search_with_word_form" style="display: inline-flex">
        ...
        <div class="card">
          ...
          <div class="card-body pt-0">
             <table class="table align-middle table-row-dashed fs-6 gy-5">
               ...
               {!! $cashback->links('dashboard.partials.paginator', ['disableJS' => true]) !!}
               <div class="row">
                <div class="col-sm-6">
                ...
                <div class="modal fade" id="subscriptions" tabindex="-1" aria-hidden="true">
                   @foreach(supportedLanguages() as $keyLang => $valueLang)
                         ...
                         <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                                                  ...
                                                  <form action="{{ route('cashback_reports')}}" class="px-7 py-5">
