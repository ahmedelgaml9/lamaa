       ...
       <div class="card">
         <div class="card-header border-0 pt-5">
          ...
          <div class="card-toolbar">
             <div class="row">
                <div class="col-lg-6">
                   <a href="{{route('cancelledorders_ToExcel', request()->query())}}" class="btn btn-sm btn-flex btn-dark btn-active-primary fw-bolder"><i class="fa fa-file-download"></i>تصدير</a>
                </div>
            </div>
        </div>
    </div>
