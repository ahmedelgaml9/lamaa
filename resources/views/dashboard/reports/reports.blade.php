...
<div class="row">
     <div class="col-sm-9">
        ...
        <div class="col-sm-3" style="padding-top:18px;">
            <a href="{{url('admin/printview/1')}}"  target="__blank" class="btn btn-danger" id="print"><i class="fa fa-print"></i></a>
       </div>
  </div>
@endforeach
    ...
    <div class="card-body">
        <div class="tab-content" id="myTabContent">
            ...
            {{__('admin.cancelled_orders_numbers')}}  : {{ $cancelled }}
            </div>
            <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
            {{__('admin.returned_orders_numbers')}}  :  {{ $returned }}
            </div>
            <div class="tab-pane fade" id="kt_tab_pane_3" role="tabpanel">
            {{__('admin.oldcarts_numbers')}}  :  {{$carts}}
            </div>
            <div class="tab-pane fade"  id="kt_tab_pane_4" role="tabpanel">

            {{__('admin.sales_total')}}  :   {{$sales}}

            </div>
            <div class="tab-pane fade" id="kt_tab_pane_5" role="tabpanel">

              {{__('admin.customers_number')}} :  {{$customers}}
                            ...
                            <div class="flex-equal me-5">
                                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                     ...
                                     <tr>
                                        ...
                                        <td class="text-gray-800"><a href="{{ route('carts.index')}}"> {{ $carts }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td class="text-gray-800"> <a href="{{ url('admin/reports/orders')}}"> {{ $delivered }}</td>
                                     </tr>
...
$("#print").attr("href", "{{url('admin/printview/2')}}")
...
$("#print").attr("href", "{{url('admin/printview/1')}}")
