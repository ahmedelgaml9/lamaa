...
<div class="col-sm-9">
  ...
  <div class="row">
  <div class="col-sm-4">
    <input name="created_at" type="text" id="created_at" class="form-control created-at-date-picker" placeholder="01-01-2022 >> 01-01-2023" required>
 </div>

     <div class="col-sm-3">
        <button type="submit" id="filters" class="btn btn-primary">{{__('admin.filter')}}</button>
       </div>
     </div>
  </form>
</div>
...
<div class="col-sm-3" style="padding-top:18px;">
     <a href="{{route('printsales')}}"  target="__blank" class="btn btn-danger" id="print"><i class="fa fa-print"></i></a>
 </div>
</div>
