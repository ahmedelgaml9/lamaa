           ...
           <div class="card-header border-0 pt-6">
               ...
               <div class="card-toolbar">
                   <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                       <a href="{{route('campaigns.create')}}" type="button" class="btn btn-primary">
                 ...
                 <table class="table align-middle table-row-dashed fs-6 gy-5" id="db_table">
                    <thead>
                       <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('admin.offer_type')}}</th>
                            <th class="min-w-125px">{{__('admin.start_at')}}</th>
                            <th class="min-w-125px">{{__('admin.expiry_date')}}</th>
                          ...
                          <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">{{__('admin.actions')}}
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="{{route('campaigns.edit', $campaign->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                            </div>

                             <div class="menu-item px-3">
                                 <a href="{{url('admin/campaign_statistics_show/'.$campaign->id)}}" class="menu-link px-3">{{__('admin.show_results')}}</a>
                             </div>
 
                               <div class="menu-item px-3">
                                   <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$campaign->id}}">{{__('admin.delete')}}</a>                      
                              </div>
                           </div>
                        </td>
                    </tr>

                       <div id="kt_modal_1{{$campaign->id}}"  tabindex="-1" class="modal fade">
                                          ...
                                          <h5 class="modal-title" >{{__('admin.Delete Confirmation')}}</h5>
                                            ...
                                            <p>{{ __('admin.Areyousure')}}</p>
                                             <div class="text-center pt-15">
                                                ...
                                                {!! Form::open(['url' => route('campaigns.destroy',  $campaign->id), 'method' => 'delete']) !!}
