                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-5 position-relative">
                                           <div class="symbol symbol-70px">
                                                <img src="{{asset('images/category/'.$row->icon)}}" alt="image"/>
                                           </div>
                                       </div>
                                   </div>
                                </td>
                                     ...
                                     <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">{{__('admin.actions')}}
                                         ...
                                         <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                           <div class="menu-item px-3">
                                                <a href="{{route('category.edit',$row->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                                          </div>
                                           <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$row->id}}">{{__('admin.delete')}}</a>
                                          </div>
                                       </div>
                                   </td>
                                                           ...
                                                           <h5 class="modal-title" >{{__('admin.Delete Confirmation')}}</h5>
                                                             ...
                                                             <div class="modal-body text-center">
                                                              ...
                                                              <div class="text-center pt-15">
                                                                ...
                                                                {!! Form::open(['url' => route('category.destroy',  $row->id), 'method' => 'delete']) !!}
