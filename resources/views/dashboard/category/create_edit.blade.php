...
@section('content')
       <div class="card card-xl-stretch mb-5 mb-xl-10">
           <div class="card-header border-0 pt-5">
             ...
             @if($data->id)
                  {!! Form::open(['url' => route('category.update', $data->id), 'method' => 'put', 'files'=>true]) !!}
             @else
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                              <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">{{__('admin.thumbnail')}}</label>
                                <div class="mb-5">
                                    @include('dashboard.components.image_upload_input', ['input_name' => 'icon', 'current_image' =>asset('images/category/'.$data->icon)])
                                </div>
                             </div>
                          </div>
                     </div>
