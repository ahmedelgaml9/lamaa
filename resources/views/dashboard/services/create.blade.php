                               ...
                               <div class="col-md-6">
                                   <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">{{__('admin.price')}}</label>
                                     <div class="mb-5 {{ $errors->has('price') ? 'has-error' : '' }}">
                                           <input type="number" step="0.01" name="price" class="form-control form-control-solid"  placeholder="0.00" min="0"/>
                               ...
                               <div class="table-responsive">
                                     <table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-bold fs-6 gy-5">
                                         ...
                                         <tbody id="new_size">
                                            <tr id="sizeform">
                                               ...
                                               <td>
                                                   <input class="form-control form-control-solid"  name="size_price[]" />
                                              </td>
                                 ...
                                 <div class="table-responsive">
                                      ...
                                      <tbody id="newRow">
                                         <tr id="inputFormRow">
                                                <td>
                                                    <input class="form-control form-control-solid" name="addition[]" />
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-solid"  name="addition_price[]" />
                                                </td>
                                                 <td  class="text-end">
