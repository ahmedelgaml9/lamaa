        ...
        <div class="card-header border-0 pt-6">
             ...
             <div class="card-toolbar">
                  <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                       <a href="{{route('mattersstype.create')}}" type="button" class="btn btn-primary">
                              ...
                              <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">{{__('admin.actions')}}
                                 ...
                                 <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                  <div class="menu-item px-3">
                                     <a href="{{route('mattersstype.edit',$type->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                                 </div>
                                   <div class="menu-item px-3">
                                       <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$type->id}}">{{__('admin.delete')}}</a>                  
                                   </div>
                                </div>
                            </td>
                          </tr>
  
                               <div id="kt_modal_1{{$type->id}}"  tabindex="-1" class="modal fade">
                                            ...
                                            <div class="modal-header" style="text-align:center;">
                                              ...
                                              <div class="modal-body text-center">
                                                ...
                                                <div class="text-center pt-15">
                                                  ...
                                                  {!! Form::open(['url' => route('mattersstype.destroy', $type->id), 'method' => 'delete']) !!}
