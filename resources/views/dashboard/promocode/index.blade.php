        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{route('promocodes.create')}}" type="button" class="btn btn-primary">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="db_table">
                ...
                <tbody class="text-gray-600 fw-bold">
                 ...
                 <tr>
                    <td>{{ ++$key }}</td>
                    <td>{{ $promo->code }}</td>
                    <td>{{ $promo->num_of_use}}</td>
                    <td>
                        {!! intStatusLabel($promo->status) !!}
                    </td>
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="{{route('promocodes.edit', $promo->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$promo->id}}">{{__('admin.delete')}}</a>                     
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div id="kt_modal_1{{$promo->id}}"  tabindex="-1" class="modal fade">
                                                  ...
                                                  <div class="modal-body text-center">
                                                     ...
                                                     <div class="text-center pt-15">
                                                      <button type="button" class="btn btn-light" data-bs-dismiss="modal" style="position:relative;float:right;">{{__('admin.Close')}}</button>
                                                        {!! Form::open(['url' => route('promocodes.destroy', $promo->id), 'method' => 'delete']) !!}
